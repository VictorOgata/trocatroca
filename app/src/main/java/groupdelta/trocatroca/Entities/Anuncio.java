...
public class Anuncio {
    ...
    public void saveNewAd(Context context){
        ...
        if (firebaseUser != null) {
            ...
            referenciaFirebase.child("Itens").child(this.item).child(this.AdID).setValue("Oferecendo");
    ...
    public void setWishList(String []wList) {
        ...
        for(int i=0;i<wList.length;i++){
            ...
            referenciaFirebase.child("Itens").child(wList[i]).child(this.AdID).setValue("Buscando");}
